...
class CanceledParcelScreen extends StatefulWidget {
  const CanceledParcelScreen({super.key});

  @override
  State<CanceledParcelScreen> createState() => _CanceledParcelScreenState();
}

class _CanceledParcelScreenState extends State<CanceledParcelScreen> {
